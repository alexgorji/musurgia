...
from musurgia.musurgia_types import check_type, create_error_message, ClockMode, ConvertibleToFraction


class Clock:
    def __init__(self, hours: int = 0, minutes: int = 0, seconds: Fraction = Fraction(0), *args: Any, **kwargs: Any) -> None:
    ...
    def set_values(self, hours: int, minutes: int, seconds: ConvertibleToFraction) -> None:
    ...
    @staticmethod
    def convert_clock_to_seconds(hours: ConvertibleToFraction, minutes: ConvertibleToFraction,
                                 seconds: ConvertibleToFraction) -> Fraction:
