...
class Test(TestCase):
    ...
    def test_1(self):
        self.assertEqual(self.ft.get_layer(0), [self.ft])

    def test_2(self):
        self.ft.add_layer()
        result = self.ft.get_children()
        self.assertEqual(self.ft.get_layer(1), result)
    ...
    def test_4(self):
        ...
        self.assertEqual(self.ft.get_layer(2), result)
    ...
    def test_5(self):
        ...
        self.assertEqual(self.ft.get_layer(3), result)
